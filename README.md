...
Este projeto é um aplicativo de desktop em Python que permite ao usuário consultar dados de endereço a partir de um CEP e, em seguida, obter a previsão do tempo (clima e temperatura) para a localidade encontrada, tudo através de uma interface gráfica (GUI) simples e funcional.
